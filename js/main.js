$(function(){
    ...
    $('.info-tabs__item').on('click', function (t) {
        t.preventDefault();
...
// e.preventDefault() - отменяет у ссылок переход на новую страницу
// .removeClass('info-tabs__content--active') - удалить класс
// $(this).addClass('info-tabs__item--active') - ту на которую кликнул добавляет класс